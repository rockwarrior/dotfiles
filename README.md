...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/rockwarrior/dotfiles/rockwarrior/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/rockwarrior/dotfiles/rockwarrior/install.sh`" -s ask
```
